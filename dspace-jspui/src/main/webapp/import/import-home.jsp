...
<dspace:layout navbar="admin" style="submission" titlekey="jsp.register.edit-profile.title" nocache="true">
	<c:choose>
		...
		<c:otherwise>
			...
			<form action="<%= request.getContextPath() %>/import-item" method="post" name="cd edit_metadata" id="edit_metadata"
			...
			<form action="<%= request.getContextPath() %>/import-item" method="post" name="edit_metadata" id="edit_metadata"
			      onkeydown="return disableEnterKey(event);">
				<div class="row">
					<span class="col-md-5">
