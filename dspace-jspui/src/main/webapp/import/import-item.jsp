...
<dspace:layout style="submission" titlekey="jsp.register.edit-profile.title" nocache="true">
  ...
  <form action="/import-item?community_id_id=123456789/28&&collection_id=9" method="post" name="edit_metadata" id="edit_metadata" onkeydown="return disableEnterKey(event);">
