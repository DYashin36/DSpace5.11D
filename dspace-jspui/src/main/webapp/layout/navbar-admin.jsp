         ...
         <ul class="nav navbar-nav">
          ...
          <li class="dropdown">
             ...
             <ul class="dropdown-menu">
               ...
               <li><a href="<%= request.getContextPath() %>/fold"><fmt:message key="jsp.layout.navbar-admin.folderschoice"/></a></li>
		           <li><a href="<%= request.getContextPath() %>/import-mass"><fmt:message key="jsp.layout.navbar-admin.foldersimport"/></a></li>           
            </ul>
          </li>
